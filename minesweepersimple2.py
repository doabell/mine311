...
class MineSweeperGame():
    ...
    def __init__(self, height: int = 9, width: int = 9, mines: int = 10):
        ...
        self.mines: set[tuple[int, int]] =set()#{(7, 1), (4, 0), (0, 0), (3, 7), (4, 6), (5, 7), (4, 5), (8, 6), (5, 3), (7, 8)} #{(2, 1), (6, 5), (2, 7), (3, 1), (6, 1), (8, 0), (4, 8), (3, 6), (1, 0), (2, 5)}
...
#                             print('c1 ',c1,constraints[c1],'c2',c2,constraints[c2])
                            frees= (constraints[c2][0]-constraints[c1][0]).copy()
                            for free in frees:
                                toclick.append(free)
